...
namespace OpenGL {
	...
	typedef GLvoid (__stdcall * PROC_glCullFace)(GLenum mode);
	typedef GLvoid (__stdcall * PROC_glFrontFace)(GLenum mode);
	typedef GLvoid (__stdcall * PROC_glHint)(GLenum target, GLenum mode);
	typedef GLvoid (__stdcall * PROC_glLineWidth)(GLfloat width);
	typedef GLvoid (__stdcall * PROC_glPointSize)(GLfloat size);
	typedef GLvoid (__stdcall * PROC_glPolygonMode)(GLenum face, GLenum mode);
	typedef GLvoid (__stdcall * PROC_glScissor)(GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glTexParameterf)(GLenum target, GLenum pname, GLfloat param);
	typedef GLvoid (__stdcall * PROC_glTexParameterfv)(GLenum target, GLenum pname, const GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glTexParameteri)(GLenum target, GLenum pname, GLint param);
	typedef GLvoid (__stdcall * PROC_glTexParameteriv)(GLenum target, GLenum pname, const GLint * params);
	typedef GLvoid (__stdcall * PROC_glTexImage1D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid * pixels);
	...
	typedef GLvoid (__stdcall * PROC_glDrawBuffer)(GLenum buf);
	...
	typedef GLvoid (__stdcall * PROC_glClearStencil)(GLint s);
	typedef GLvoid (__stdcall * PROC_glClearDepth)(GLdouble depth);
	typedef GLvoid (__stdcall * PROC_glStencilMask)(GLuint mask);
	typedef GLvoid (__stdcall * PROC_glColorMask)(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
	typedef GLvoid (__stdcall * PROC_glDepthMask)(GLboolean flag);
	typedef GLvoid (__stdcall * PROC_glDisable)(GLenum cap);
	typedef GLvoid (__stdcall * PROC_glEnable)(GLenum cap);
	typedef GLvoid (__stdcall * PROC_glFinish)();
	typedef GLvoid (__stdcall * PROC_glFlush)();
	typedef GLvoid (__stdcall * PROC_glBlendFunc)(GLenum sfactor, GLenum dfactor);
	typedef GLvoid (__stdcall * PROC_glLogicOp)(GLenum opcode);
	typedef GLvoid (__stdcall * PROC_glStencilFunc)(GLenum func, GLint ref, GLuint mask);
	typedef GLvoid (__stdcall * PROC_glStencilOp)(GLenum fail, GLenum zfail, GLenum zpass);
	typedef GLvoid (__stdcall * PROC_glDepthFunc)(GLenum func);
	typedef GLvoid (__stdcall * PROC_glPixelStoref)(GLenum pname, GLfloat param);
	typedef GLvoid (__stdcall * PROC_glPixelStorei)(GLenum pname, GLint param);
	typedef GLvoid (__stdcall * PROC_glReadBuffer)(GLenum src);
	...
	typedef GLvoid (__stdcall * PROC_glGetBooleanv)(GLenum pname, GLboolean * data);
	typedef GLvoid (__stdcall * PROC_glGetDoublev)(GLenum pname, GLdouble * data);
	typedef GLenum (__stdcall * PROC_glGetError)();
	typedef GLvoid (__stdcall * PROC_glGetFloatv)(GLenum pname, GLfloat * data);
	...
	typedef GLvoid (__stdcall * PROC_glGetTexImage)(GLenum target, GLint level, GLenum format, GLenum type, GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glGetTexParameterfv)(GLenum target, GLenum pname, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetTexParameteriv)(GLenum target, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetTexLevelParameterfv)(GLenum target, GLint level, GLenum pname, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetTexLevelParameteriv)(GLenum target, GLint level, GLenum pname, GLint * params);
	typedef GLboolean (__stdcall * PROC_glIsEnabled)(GLenum cap);
	typedef GLvoid (__stdcall * PROC_glDepthRange)(GLdouble near, GLdouble far);
	typedef GLvoid (__stdcall * PROC_glViewport)(GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glDrawArrays)(GLenum mode, GLint first, GLsizei count);
	typedef GLvoid (__stdcall * PROC_glDrawElements)(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices);
	typedef GLvoid (__stdcall * PROC_glGetPointerv)(GLenum pname, GLvoid ** params);
	typedef GLvoid (__stdcall * PROC_glPolygonOffset)(GLfloat factor, GLfloat units);
	typedef GLvoid (__stdcall * PROC_glCopyTexImage1D)(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border);
	typedef GLvoid (__stdcall * PROC_glCopyTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border);
	typedef GLvoid (__stdcall * PROC_glCopyTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
	typedef GLvoid (__stdcall * PROC_glCopyTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid * pixels);
	...
	typedef GLboolean (__stdcall * PROC_glIsTexture)(GLuint texture);
	typedef GLvoid (__stdcall * PROC_glDrawRangeElements)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid * indices);
	typedef GLvoid (__stdcall * PROC_glTexImage3D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glCopyTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glActiveTexture)(GLenum texture);
	typedef GLvoid (__stdcall * PROC_glSampleCoverage)(GLfloat value, GLboolean invert);
	typedef GLvoid (__stdcall * PROC_glCompressedTexImage3D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCompressedTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCompressedTexImage1D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCompressedTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCompressedTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCompressedTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glGetCompressedTexImage)(GLenum target, GLint level, GLvoid * img);
	typedef GLvoid (__stdcall * PROC_glBlendFuncSeparate)(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
	typedef GLvoid (__stdcall * PROC_glMultiDrawArrays)(GLenum mode, const GLint * first, const GLsizei * count, GLsizei drawcount);
	typedef GLvoid (__stdcall * PROC_glMultiDrawElements)(GLenum mode, const GLsizei * count, GLenum type, const GLvoid * const* indices, GLsizei drawcount);
	typedef GLvoid (__stdcall * PROC_glPointParameterf)(GLenum pname, GLfloat param);
	typedef GLvoid (__stdcall * PROC_glPointParameterfv)(GLenum pname, const GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glPointParameteri)(GLenum pname, GLint param);
	typedef GLvoid (__stdcall * PROC_glPointParameteriv)(GLenum pname, const GLint * params);
	typedef GLvoid (__stdcall * PROC_glBlendColor)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
	typedef GLvoid (__stdcall * PROC_glBlendEquation)(GLenum mode);
	typedef GLvoid (__stdcall * PROC_glGenQueries)(GLsizei n, GLuint * ids);
	typedef GLvoid (__stdcall * PROC_glDeleteQueries)(GLsizei n, const GLuint * ids);
	typedef GLboolean (__stdcall * PROC_glIsQuery)(GLuint id);
	typedef GLvoid (__stdcall * PROC_glBeginQuery)(GLenum target, GLuint id);
	typedef GLvoid (__stdcall * PROC_glEndQuery)(GLenum target);
	typedef GLvoid (__stdcall * PROC_glGetQueryiv)(GLenum target, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetQueryObjectiv)(GLuint id, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetQueryObjectuiv)(GLuint id, GLenum pname, GLuint * params);
	...
	typedef GLboolean (__stdcall * PROC_glIsBuffer)(GLuint buffer);
	...
	typedef GLvoid (__stdcall * PROC_glGetBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, GLvoid * data);
	typedef GLvoid * (__stdcall * PROC_glMapBuffer)(GLenum target, GLenum access);
	...
	typedef GLvoid (__stdcall * PROC_glGetBufferPointerv)(GLenum target, GLenum pname, GLvoid ** params);
	typedef GLvoid (__stdcall * PROC_glBlendEquationSeparate)(GLenum modeRGB, GLenum modeAlpha);
	typedef GLvoid (__stdcall * PROC_glDrawBuffers)(GLsizei n, const GLenum * bufs);
	typedef GLvoid (__stdcall * PROC_glStencilOpSeparate)(GLenum face, GLenum sfail, GLenum dpfail, GLenum dppass);
	typedef GLvoid (__stdcall * PROC_glStencilFuncSeparate)(GLenum face, GLenum func, GLint ref, GLuint mask);
	typedef GLvoid (__stdcall * PROC_glStencilMaskSeparate)(GLenum face, GLuint mask);
	typedef GLvoid (__stdcall * PROC_glAttachShader)(GLuint program, GLuint shader);
	typedef GLvoid (__stdcall * PROC_glBindAttribLocation)(GLuint program, GLuint index, const GLchar * name);
	...
	typedef GLvoid (__stdcall * PROC_glDetachShader)(GLuint program, GLuint shader);
	...
	typedef GLvoid (__stdcall * PROC_glGetActiveAttrib)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
	typedef GLvoid (__stdcall * PROC_glGetActiveUniform)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
	...
	typedef GLvoid (__stdcall * PROC_glGetShaderSource)(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * source);
	typedef GLint (__stdcall * PROC_glGetUniformLocation)(GLuint program, const GLchar * name);
	typedef GLvoid (__stdcall * PROC_glGetUniformfv)(GLuint program, GLint location, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetUniformiv)(GLuint program, GLint location, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetVertexAttribdv)(GLuint index, GLenum pname, GLdouble * params);
	typedef GLvoid (__stdcall * PROC_glGetVertexAttribfv)(GLuint index, GLenum pname, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetVertexAttribiv)(GLuint index, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetVertexAttribPointerv)(GLuint index, GLenum pname, GLvoid ** pointer);
	typedef GLboolean (__stdcall * PROC_glIsProgram)(GLuint program);
	typedef GLboolean (__stdcall * PROC_glIsShader)(GLuint shader);
	...
	typedef GLvoid (__stdcall * PROC_glUniform1fv)(GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniform2fv)(GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniform3fv)(GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniform4fv)(GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniform1iv)(GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glUniform2iv)(GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glUniform3iv)(GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glUniform4iv)(GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glValidateProgram)(GLuint program);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib1d)(GLuint index, GLdouble x);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib1dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib1f)(GLuint index, GLfloat x);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib1fv)(GLuint index, const GLfloat * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib1s)(GLuint index, GLshort x);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib1sv)(GLuint index, const GLshort * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib2d)(GLuint index, GLdouble x, GLdouble y);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib2dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib2f)(GLuint index, GLfloat x, GLfloat y);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib2fv)(GLuint index, const GLfloat * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib2s)(GLuint index, GLshort x, GLshort y);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib2sv)(GLuint index, const GLshort * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib3d)(GLuint index, GLdouble x, GLdouble y, GLdouble z);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib3dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib3f)(GLuint index, GLfloat x, GLfloat y, GLfloat z);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib3fv)(GLuint index, const GLfloat * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib3s)(GLuint index, GLshort x, GLshort y, GLshort z);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib3sv)(GLuint index, const GLshort * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4Nbv)(GLuint index, const GLbyte * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4Niv)(GLuint index, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4Nsv)(GLuint index, const GLshort * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4Nub)(GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4Nubv)(GLuint index, const GLubyte * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4Nuiv)(GLuint index, const GLuint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4Nusv)(GLuint index, const GLushort * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4bv)(GLuint index, const GLbyte * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4d)(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4f)(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4fv)(GLuint index, const GLfloat * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4iv)(GLuint index, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4s)(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4sv)(GLuint index, const GLshort * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4ubv)(GLuint index, const GLubyte * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4uiv)(GLuint index, const GLuint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttrib4usv)(GLuint index, const GLushort * v);
	...
	typedef GLvoid (__stdcall * PROC_glUniformMatrix2x3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix3x2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix2x4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix4x2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix3x4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix4x3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glColorMaski)(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
	typedef GLvoid (__stdcall * PROC_glGetBooleani_v)(GLenum target, GLuint index, GLboolean * data);
	typedef GLvoid (__stdcall * PROC_glGetIntegeri_v)(GLenum target, GLuint index, GLint * data);
	typedef GLvoid (__stdcall * PROC_glEnablei)(GLenum target, GLuint index);
	typedef GLvoid (__stdcall * PROC_glDisablei)(GLenum target, GLuint index);
	typedef GLboolean (__stdcall * PROC_glIsEnabledi)(GLenum target, GLuint index);
	typedef GLvoid (__stdcall * PROC_glBeginTransformFeedback)(GLenum primitiveMode);
	typedef GLvoid (__stdcall * PROC_glEndTransformFeedback)();
	typedef GLvoid (__stdcall * PROC_glBindBufferRange)(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
	typedef GLvoid (__stdcall * PROC_glBindBufferBase)(GLenum target, GLuint index, GLuint buffer);
	typedef GLvoid (__stdcall * PROC_glTransformFeedbackVaryings)(GLuint program, GLsizei count, const GLchar * const* varyings, GLenum bufferMode);
	typedef GLvoid (__stdcall * PROC_glGetTransformFeedbackVarying)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLsizei * size, GLenum * type, GLchar * name);
	typedef GLvoid (__stdcall * PROC_glClampColor)(GLenum target, GLenum clamp);
	typedef GLvoid (__stdcall * PROC_glBeginConditionalRender)(GLuint id, GLenum mode);
	typedef GLvoid (__stdcall * PROC_glEndConditionalRender)();
	typedef GLvoid (__stdcall * PROC_glVertexAttribIPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid * pointer);
	typedef GLvoid (__stdcall * PROC_glGetVertexAttribIiv)(GLuint index, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetVertexAttribIuiv)(GLuint index, GLenum pname, GLuint * params);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI1i)(GLuint index, GLint x);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI2i)(GLuint index, GLint x, GLint y);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI3i)(GLuint index, GLint x, GLint y, GLint z);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4i)(GLuint index, GLint x, GLint y, GLint z, GLint w);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI1ui)(GLuint index, GLuint x);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI2ui)(GLuint index, GLuint x, GLuint y);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI3ui)(GLuint index, GLuint x, GLuint y, GLuint z);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4ui)(GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI1iv)(GLuint index, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI2iv)(GLuint index, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI3iv)(GLuint index, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4iv)(GLuint index, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI1uiv)(GLuint index, const GLuint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI2uiv)(GLuint index, const GLuint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI3uiv)(GLuint index, const GLuint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4uiv)(GLuint index, const GLuint * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4bv)(GLuint index, const GLbyte * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4sv)(GLuint index, const GLshort * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4ubv)(GLuint index, const GLubyte * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribI4usv)(GLuint index, const GLushort * v);
	typedef GLvoid (__stdcall * PROC_glGetUniformuiv)(GLuint program, GLint location, GLuint * params);
	typedef GLvoid (__stdcall * PROC_glBindFragDataLocation)(GLuint program, GLuint color, const GLchar * name);
	typedef GLint (__stdcall * PROC_glGetFragDataLocation)(GLuint program, const GLchar * name);
	typedef GLvoid (__stdcall * PROC_glUniform1ui)(GLint location, GLuint v0);
	typedef GLvoid (__stdcall * PROC_glUniform2ui)(GLint location, GLuint v0, GLuint v1);
	typedef GLvoid (__stdcall * PROC_glUniform3ui)(GLint location, GLuint v0, GLuint v1, GLuint v2);
	typedef GLvoid (__stdcall * PROC_glUniform4ui)(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
	typedef GLvoid (__stdcall * PROC_glUniform1uiv)(GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glUniform2uiv)(GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glUniform3uiv)(GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glUniform4uiv)(GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glTexParameterIiv)(GLenum target, GLenum pname, const GLint * params);
	typedef GLvoid (__stdcall * PROC_glTexParameterIuiv)(GLenum target, GLenum pname, const GLuint * params);
	typedef GLvoid (__stdcall * PROC_glGetTexParameterIiv)(GLenum target, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetTexParameterIuiv)(GLenum target, GLenum pname, GLuint * params);
	typedef GLvoid (__stdcall * PROC_glClearBufferiv)(GLenum buffer, GLint drawbuffer, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glClearBufferuiv)(GLenum buffer, GLint drawbuffer, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glClearBufferfv)(GLenum buffer, GLint drawbuffer, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glClearBufferfi)(GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
	typedef const GLubyte * (__stdcall * PROC_glGetStringi)(GLenum name, GLuint index);
	typedef GLboolean (__stdcall * PROC_glIsRenderbuffer)(GLuint renderbuffer);
	typedef GLvoid (__stdcall * PROC_glBindRenderbuffer)(GLenum target, GLuint renderbuffer);
	typedef GLvoid (__stdcall * PROC_glDeleteRenderbuffers)(GLsizei n, const GLuint * renderbuffers);
	typedef GLvoid (__stdcall * PROC_glGenRenderbuffers)(GLsizei n, GLuint * renderbuffers);
	typedef GLvoid (__stdcall * PROC_glRenderbufferStorage)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glGetRenderbufferParameteriv)(GLenum target, GLenum pname, GLint * params);
	typedef GLboolean (__stdcall * PROC_glIsFramebuffer)(GLuint framebuffer);
	...
	typedef GLenum (__stdcall * PROC_glCheckFramebufferStatus)(GLenum target);
	typedef GLvoid (__stdcall * PROC_glFramebufferTexture1D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
	...
	typedef GLvoid (__stdcall * PROC_glFramebufferTexture3D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset);
	typedef GLvoid (__stdcall * PROC_glFramebufferRenderbuffer)(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
	...
	typedef GLvoid (__stdcall * PROC_glBlitFramebuffer)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
	typedef GLvoid (__stdcall * PROC_glRenderbufferStorageMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glFramebufferTextureLayer)(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
	typedef GLvoid * (__stdcall * PROC_glMapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
	typedef GLvoid (__stdcall * PROC_glFlushMappedBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length);
	...
	typedef GLboolean (__stdcall * PROC_glIsVertexArray)(GLuint array);
	...
	typedef GLvoid (__stdcall * PROC_glTexBuffer)(GLenum target, GLenum internalformat, GLuint buffer);
	typedef GLvoid (__stdcall * PROC_glPrimitiveRestartIndex)(GLuint index);
	typedef GLvoid (__stdcall * PROC_glCopyBufferSubData)(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
	typedef GLvoid (__stdcall * PROC_glGetUniformIndices)(GLuint program, GLsizei uniformCount, const GLchar * const* uniformNames, GLuint * uniformIndices);
	typedef GLvoid (__stdcall * PROC_glGetActiveUniformsiv)(GLuint program, GLsizei uniformCount, const GLuint * uniformIndices, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetActiveUniformName)(GLuint program, GLuint uniformIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformName);
	typedef GLuint (__stdcall * PROC_glGetUniformBlockIndex)(GLuint program, const GLchar * uniformBlockName);
	typedef GLvoid (__stdcall * PROC_glGetActiveUniformBlockiv)(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetActiveUniformBlockName)(GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformBlockName);
	typedef GLvoid (__stdcall * PROC_glUniformBlockBinding)(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding);
	typedef GLvoid (__stdcall * PROC_glDrawElementsBaseVertex)(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices, GLint basevertex);
	typedef GLvoid (__stdcall * PROC_glDrawRangeElementsBaseVertex)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid * indices, GLint basevertex);
	typedef GLvoid (__stdcall * PROC_glDrawElementsInstancedBaseVertex)(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices, GLsizei instancecount, GLint basevertex);
	typedef GLvoid (__stdcall * PROC_glMultiDrawElementsBaseVertex)(GLenum mode, const GLsizei * count, GLenum type, const GLvoid * const* indices, GLsizei drawcount, const GLint * basevertex);
	typedef GLvoid (__stdcall * PROC_glProvokingVertex)(GLenum mode);
	typedef GLsync (__stdcall * PROC_glFenceSync)(GLenum condition, GLbitfield flags);
	typedef GLboolean (__stdcall * PROC_glIsSync)(GLsync sync);
	typedef GLvoid (__stdcall * PROC_glDeleteSync)(GLsync sync);
	typedef GLenum (__stdcall * PROC_glClientWaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);
	typedef GLvoid (__stdcall * PROC_glWaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);
	typedef GLvoid (__stdcall * PROC_glGetInteger64v)(GLenum pname, GLint64 * data);
	typedef GLvoid (__stdcall * PROC_glGetSynciv)(GLsync sync, GLenum pname, GLsizei bufSize, GLsizei * length, GLint * values);
	typedef GLvoid (__stdcall * PROC_glGetInteger64i_v)(GLenum target, GLuint index, GLint64 * data);
	typedef GLvoid (__stdcall * PROC_glGetBufferParameteri64v)(GLenum target, GLenum pname, GLint64 * params);
	typedef GLvoid (__stdcall * PROC_glFramebufferTexture)(GLenum target, GLenum attachment, GLuint texture, GLint level);
	...
	typedef GLvoid (__stdcall * PROC_glTexImage3DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
	typedef GLvoid (__stdcall * PROC_glGetMultisamplefv)(GLenum pname, GLuint index, GLfloat * val);
	typedef GLvoid (__stdcall * PROC_glSampleMaski)(GLuint maskNumber, GLbitfield mask);
	typedef GLvoid (__stdcall * PROC_glBindFragDataLocationIndexed)(GLuint program, GLuint colorNumber, GLuint index, const GLchar * name);
	typedef GLint (__stdcall * PROC_glGetFragDataIndex)(GLuint program, const GLchar * name);
	typedef GLvoid (__stdcall * PROC_glGenSamplers)(GLsizei count, GLuint * samplers);
	typedef GLvoid (__stdcall * PROC_glDeleteSamplers)(GLsizei count, const GLuint * samplers);
	typedef GLboolean (__stdcall * PROC_glIsSampler)(GLuint sampler);
	typedef GLvoid (__stdcall * PROC_glBindSampler)(GLuint unit, GLuint sampler);
	typedef GLvoid (__stdcall * PROC_glSamplerParameteri)(GLuint sampler, GLenum pname, GLint param);
	typedef GLvoid (__stdcall * PROC_glSamplerParameteriv)(GLuint sampler, GLenum pname, const GLint * param);
	typedef GLvoid (__stdcall * PROC_glSamplerParameterf)(GLuint sampler, GLenum pname, GLfloat param);
	typedef GLvoid (__stdcall * PROC_glSamplerParameterfv)(GLuint sampler, GLenum pname, const GLfloat * param);
	typedef GLvoid (__stdcall * PROC_glSamplerParameterIiv)(GLuint sampler, GLenum pname, const GLint * param);
	typedef GLvoid (__stdcall * PROC_glSamplerParameterIuiv)(GLuint sampler, GLenum pname, const GLuint * param);
	typedef GLvoid (__stdcall * PROC_glGetSamplerParameteriv)(GLuint sampler, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetSamplerParameterIiv)(GLuint sampler, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetSamplerParameterfv)(GLuint sampler, GLenum pname, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetSamplerParameterIuiv)(GLuint sampler, GLenum pname, GLuint * params);
	typedef GLvoid (__stdcall * PROC_glQueryCounter)(GLuint id, GLenum target);
	typedef GLvoid (__stdcall * PROC_glGetQueryObjecti64v)(GLuint id, GLenum pname, GLint64 * params);
	typedef GLvoid (__stdcall * PROC_glGetQueryObjectui64v)(GLuint id, GLenum pname, GLuint64 * params);
	typedef GLvoid (__stdcall * PROC_glVertexAttribDivisor)(GLuint index, GLuint divisor);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP1ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP1uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP2ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP2uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP3ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP3uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP4ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
	typedef GLvoid (__stdcall * PROC_glVertexAttribP4uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glMinSampleShading)(GLfloat value);
	typedef GLvoid (__stdcall * PROC_glBlendEquationi)(GLuint buf, GLenum mode);
	typedef GLvoid (__stdcall * PROC_glBlendEquationSeparatei)(GLuint buf, GLenum modeRGB, GLenum modeAlpha);
	typedef GLvoid (__stdcall * PROC_glBlendFunci)(GLuint buf, GLenum src, GLenum dst);
	typedef GLvoid (__stdcall * PROC_glBlendFuncSeparatei)(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
	typedef GLvoid (__stdcall * PROC_glDrawArraysIndirect)(GLenum mode, const GLvoid * indirect);
	typedef GLvoid (__stdcall * PROC_glDrawElementsIndirect)(GLenum mode, GLenum type, const GLvoid * indirect);
	typedef GLvoid (__stdcall * PROC_glUniform1d)(GLint location, GLdouble x);
	typedef GLvoid (__stdcall * PROC_glUniform2d)(GLint location, GLdouble x, GLdouble y);
	typedef GLvoid (__stdcall * PROC_glUniform3d)(GLint location, GLdouble x, GLdouble y, GLdouble z);
	typedef GLvoid (__stdcall * PROC_glUniform4d)(GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
	typedef GLvoid (__stdcall * PROC_glUniform1dv)(GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniform2dv)(GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniform3dv)(GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniform4dv)(GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix2x3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix2x4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix3x2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix3x4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix4x2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glUniformMatrix4x3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glGetUniformdv)(GLuint program, GLint location, GLdouble * params);
	typedef GLint (__stdcall * PROC_glGetSubroutineUniformLocation)(GLuint program, GLenum shadertype, const GLchar * name);
	typedef GLuint (__stdcall * PROC_glGetSubroutineIndex)(GLuint program, GLenum shadertype, const GLchar * name);
	typedef GLvoid (__stdcall * PROC_glGetActiveSubroutineUniformiv)(GLuint program, GLenum shadertype, GLuint index, GLenum pname, GLint * values);
	typedef GLvoid (__stdcall * PROC_glGetActiveSubroutineUniformName)(GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei * length, GLchar * name);
	typedef GLvoid (__stdcall * PROC_glGetActiveSubroutineName)(GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei * length, GLchar * name);
	typedef GLvoid (__stdcall * PROC_glUniformSubroutinesuiv)(GLenum shadertype, GLsizei count, const GLuint * indices);
	typedef GLvoid (__stdcall * PROC_glGetUniformSubroutineuiv)(GLenum shadertype, GLint location, GLuint * params);
	typedef GLvoid (__stdcall * PROC_glGetProgramStageiv)(GLuint program, GLenum shadertype, GLenum pname, GLint * values);
	typedef GLvoid (__stdcall * PROC_glPatchParameteri)(GLenum pname, GLint value);
	typedef GLvoid (__stdcall * PROC_glPatchParameterfv)(GLenum pname, const GLfloat * values);
	typedef GLvoid (__stdcall * PROC_glBindTransformFeedback)(GLenum target, GLuint id);
	typedef GLvoid (__stdcall * PROC_glDeleteTransformFeedbacks)(GLsizei n, const GLuint * ids);
	typedef GLvoid (__stdcall * PROC_glGenTransformFeedbacks)(GLsizei n, GLuint * ids);
	typedef GLboolean (__stdcall * PROC_glIsTransformFeedback)(GLuint id);
	typedef GLvoid (__stdcall * PROC_glPauseTransformFeedback)();
	typedef GLvoid (__stdcall * PROC_glResumeTransformFeedback)();
	typedef GLvoid (__stdcall * PROC_glDrawTransformFeedback)(GLenum mode, GLuint id);
	typedef GLvoid (__stdcall * PROC_glDrawTransformFeedbackStream)(GLenum mode, GLuint id, GLuint stream);
	typedef GLvoid (__stdcall * PROC_glBeginQueryIndexed)(GLenum target, GLuint index, GLuint id);
	typedef GLvoid (__stdcall * PROC_glEndQueryIndexed)(GLenum target, GLuint index);
	typedef GLvoid (__stdcall * PROC_glGetQueryIndexediv)(GLenum target, GLuint index, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glReleaseShaderCompiler)();
	typedef GLvoid (__stdcall * PROC_glShaderBinary)(GLsizei count, const GLuint * shaders, GLenum binaryformat, const GLvoid * binary, GLsizei length);
	typedef GLvoid (__stdcall * PROC_glGetShaderPrecisionFormat)(GLenum shadertype, GLenum precisiontype, GLint * range, GLint * precision);
	typedef GLvoid (__stdcall * PROC_glDepthRangef)(GLfloat n, GLfloat f);
	typedef GLvoid (__stdcall * PROC_glClearDepthf)(GLfloat d);
	typedef GLvoid (__stdcall * PROC_glGetProgramBinary)(GLuint program, GLsizei bufSize, GLsizei * length, GLenum * binaryFormat, GLvoid * binary);
	typedef GLvoid (__stdcall * PROC_glProgramBinary)(GLuint program, GLenum binaryFormat, const GLvoid * binary, GLsizei length);
	typedef GLvoid (__stdcall * PROC_glProgramParameteri)(GLuint program, GLenum pname, GLint value);
	typedef GLvoid (__stdcall * PROC_glUseProgramStages)(GLuint pipeline, GLbitfield stages, GLuint program);
	typedef GLvoid (__stdcall * PROC_glActiveShaderProgram)(GLuint pipeline, GLuint program);
	typedef GLuint (__stdcall * PROC_glCreateShaderProgramv)(GLenum type, GLsizei count, const GLchar * const* strings);
	typedef GLvoid (__stdcall * PROC_glBindProgramPipeline)(GLuint pipeline);
	typedef GLvoid (__stdcall * PROC_glDeleteProgramPipelines)(GLsizei n, const GLuint * pipelines);
	typedef GLvoid (__stdcall * PROC_glGenProgramPipelines)(GLsizei n, GLuint * pipelines);
	typedef GLboolean (__stdcall * PROC_glIsProgramPipeline)(GLuint pipeline);
	typedef GLvoid (__stdcall * PROC_glGetProgramPipelineiv)(GLuint pipeline, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1i)(GLuint program, GLint location, GLint v0);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1f)(GLuint program, GLint location, GLfloat v0);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1d)(GLuint program, GLint location, GLdouble v0);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1ui)(GLuint program, GLint location, GLuint v0);
	typedef GLvoid (__stdcall * PROC_glProgramUniform1uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2i)(GLuint program, GLint location, GLint v0, GLint v1);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2f)(GLuint program, GLint location, GLfloat v0, GLfloat v1);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2d)(GLuint program, GLint location, GLdouble v0, GLdouble v1);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2ui)(GLuint program, GLint location, GLuint v0, GLuint v1);
	typedef GLvoid (__stdcall * PROC_glProgramUniform2uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3i)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3ui)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2);
	typedef GLvoid (__stdcall * PROC_glProgramUniform3uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4i)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4iv)(GLuint program, GLint location, GLsizei count, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4fv)(GLuint program, GLint location, GLsizei count, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2, GLdouble v3);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4dv)(GLuint program, GLint location, GLsizei count, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4ui)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
	typedef GLvoid (__stdcall * PROC_glProgramUniform4uiv)(GLuint program, GLint location, GLsizei count, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix2fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix3fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix4fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix2dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix3dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix4dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix2x3fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix3x2fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix2x4fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix4x2fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix3x4fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix4x3fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix2x3dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix3x2dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix2x4dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix4x2dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix3x4dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glProgramUniformMatrix4x3dv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble * value);
	typedef GLvoid (__stdcall * PROC_glValidateProgramPipeline)(GLuint pipeline);
	typedef GLvoid (__stdcall * PROC_glGetProgramPipelineInfoLog)(GLuint pipeline, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL1d)(GLuint index, GLdouble x);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL2d)(GLuint index, GLdouble x, GLdouble y);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL3d)(GLuint index, GLdouble x, GLdouble y, GLdouble z);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL4d)(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL1dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL2dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL3dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribL4dv)(GLuint index, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glVertexAttribLPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid * pointer);
	typedef GLvoid (__stdcall * PROC_glGetVertexAttribLdv)(GLuint index, GLenum pname, GLdouble * params);
	typedef GLvoid (__stdcall * PROC_glViewportArrayv)(GLuint first, GLsizei count, const GLfloat * v);
	typedef GLvoid (__stdcall * PROC_glViewportIndexedf)(GLuint index, GLfloat x, GLfloat y, GLfloat w, GLfloat h);
	typedef GLvoid (__stdcall * PROC_glViewportIndexedfv)(GLuint index, const GLfloat * v);
	typedef GLvoid (__stdcall * PROC_glScissorArrayv)(GLuint first, GLsizei count, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glScissorIndexed)(GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glScissorIndexedv)(GLuint index, const GLint * v);
	typedef GLvoid (__stdcall * PROC_glDepthRangeArrayv)(GLuint first, GLsizei count, const GLdouble * v);
	typedef GLvoid (__stdcall * PROC_glDepthRangeIndexed)(GLuint index, GLdouble n, GLdouble f);
	typedef GLvoid (__stdcall * PROC_glGetFloati_v)(GLenum target, GLuint index, GLfloat * data);
	typedef GLvoid (__stdcall * PROC_glGetDoublei_v)(GLenum target, GLuint index, GLdouble * data);
	typedef GLvoid (__stdcall * PROC_glDrawArraysInstancedBaseInstance)(GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance);
	typedef GLvoid (__stdcall * PROC_glDrawElementsInstancedBaseInstance)(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices, GLsizei instancecount, GLuint baseinstance);
	typedef GLvoid (__stdcall * PROC_glDrawElementsInstancedBaseVertexBaseInstance)(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance);
	typedef GLvoid (__stdcall * PROC_glGetInternalformativ)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetActiveAtomicCounterBufferiv)(GLuint program, GLuint bufferIndex, GLenum pname, GLint * params);
	...
	typedef GLvoid (__stdcall * PROC_glMemoryBarrier)(GLbitfield barriers);
	typedef GLvoid (__stdcall * PROC_glTexStorage1D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);
	typedef GLvoid (__stdcall * PROC_glTexStorage2D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glTexStorage3D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
	typedef GLvoid (__stdcall * PROC_glDrawTransformFeedbackInstanced)(GLenum mode, GLuint id, GLsizei instancecount);
	typedef GLvoid (__stdcall * PROC_glDrawTransformFeedbackStreamInstanced)(GLenum mode, GLuint id, GLuint stream, GLsizei instancecount);
	typedef GLvoid (__stdcall * PROC_glClearBufferData)(GLenum target, GLenum internalformat, GLenum format, GLenum type, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glClearBufferSubData)(GLenum target, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glDispatchCompute)(GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z);
	typedef GLvoid (__stdcall * PROC_glDispatchComputeIndirect)(GLintptr indirect);
	typedef GLvoid (__stdcall * PROC_glCopyImageSubData)(GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth);
	typedef GLvoid (__stdcall * PROC_glFramebufferParameteri)(GLenum target, GLenum pname, GLint param);
	typedef GLvoid (__stdcall * PROC_glGetFramebufferParameteriv)(GLenum target, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetInternalformati64v)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint64 * params);
	typedef GLvoid (__stdcall * PROC_glInvalidateTexSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth);
	typedef GLvoid (__stdcall * PROC_glInvalidateTexImage)(GLuint texture, GLint level);
	typedef GLvoid (__stdcall * PROC_glInvalidateBufferSubData)(GLuint buffer, GLintptr offset, GLsizeiptr length);
	typedef GLvoid (__stdcall * PROC_glInvalidateBufferData)(GLuint buffer);
	typedef GLvoid (__stdcall * PROC_glInvalidateFramebuffer)(GLenum target, GLsizei numAttachments, const GLenum * attachments);
	typedef GLvoid (__stdcall * PROC_glInvalidateSubFramebuffer)(GLenum target, GLsizei numAttachments, const GLenum * attachments, GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glMultiDrawArraysIndirect)(GLenum mode, const GLvoid * indirect, GLsizei drawcount, GLsizei stride);
	typedef GLvoid (__stdcall * PROC_glMultiDrawElementsIndirect)(GLenum mode, GLenum type, const GLvoid * indirect, GLsizei drawcount, GLsizei stride);
	typedef GLvoid (__stdcall * PROC_glGetProgramInterfaceiv)(GLuint program, GLenum programInterface, GLenum pname, GLint * params);
	typedef GLuint (__stdcall * PROC_glGetProgramResourceIndex)(GLuint program, GLenum programInterface, const GLchar * name);
	typedef GLvoid (__stdcall * PROC_glGetProgramResourceName)(GLuint program, GLenum programInterface, GLuint index, GLsizei bufSize, GLsizei * length, GLchar * name);
	typedef GLvoid (__stdcall * PROC_glGetProgramResourceiv)(GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei bufSize, GLsizei * length, GLint * params);
	typedef GLint (__stdcall * PROC_glGetProgramResourceLocation)(GLuint program, GLenum programInterface, const GLchar * name);
	typedef GLint (__stdcall * PROC_glGetProgramResourceLocationIndex)(GLuint program, GLenum programInterface, const GLchar * name);
	typedef GLvoid (__stdcall * PROC_glShaderStorageBlockBinding)(GLuint program, GLuint storageBlockIndex, GLuint storageBlockBinding);
	typedef GLvoid (__stdcall * PROC_glTexBufferRange)(GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
	typedef GLvoid (__stdcall * PROC_glTexStorage2DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
	typedef GLvoid (__stdcall * PROC_glTexStorage3DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
	typedef GLvoid (__stdcall * PROC_glTextureView)(GLuint texture, GLenum target, GLuint origtexture, GLenum internalformat, GLuint minlevel, GLuint numlevels, GLuint minlayer, GLuint numlayers);
	typedef GLvoid (__stdcall * PROC_glBindVertexBuffer)(GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
	typedef GLvoid (__stdcall * PROC_glVertexAttribFormat)(GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
	typedef GLvoid (__stdcall * PROC_glVertexAttribIFormat)(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
	typedef GLvoid (__stdcall * PROC_glVertexAttribLFormat)(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
	typedef GLvoid (__stdcall * PROC_glVertexAttribBinding)(GLuint attribindex, GLuint bindingindex);
	typedef GLvoid (__stdcall * PROC_glVertexBindingDivisor)(GLuint bindingindex, GLuint divisor);
	typedef GLvoid (__stdcall * PROC_glDebugMessageControl)(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint * ids, GLboolean enabled);
	typedef GLvoid (__stdcall * PROC_glDebugMessageInsert)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar * buf);
	typedef GLvoid (__stdcall * PROC_glDebugMessageCallback)(GLDEBUGPROC callback, const GLvoid * userParam);
	typedef GLuint (__stdcall * PROC_glGetDebugMessageLog)(GLuint count, GLsizei bufSize, GLenum * sources, GLenum * types, GLuint * ids, GLenum * severities, GLsizei * lengths, GLchar * messageLog);
	typedef GLvoid (__stdcall * PROC_glPushDebugGroup)(GLenum source, GLuint id, GLsizei length, const GLchar * message);
	typedef GLvoid (__stdcall * PROC_glPopDebugGroup)();
	typedef GLvoid (__stdcall * PROC_glObjectLabel)(GLenum identifier, GLuint name, GLsizei length, const GLchar * label);
	typedef GLvoid (__stdcall * PROC_glGetObjectLabel)(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei * length, GLchar * label);
	typedef GLvoid (__stdcall * PROC_glObjectPtrLabel)(const GLvoid * ptr, GLsizei length, const GLchar * label);
	typedef GLvoid (__stdcall * PROC_glGetObjectPtrLabel)(const GLvoid * ptr, GLsizei bufSize, GLsizei * length, GLchar * label);
	typedef GLvoid (__stdcall * PROC_glBufferStorage)(GLenum target, GLsizeiptr size, const GLvoid * data, GLbitfield flags);
	typedef GLvoid (__stdcall * PROC_glClearTexImage)(GLuint texture, GLint level, GLenum format, GLenum type, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glClearTexSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glBindBuffersBase)(GLenum target, GLuint first, GLsizei count, const GLuint * buffers);
	typedef GLvoid (__stdcall * PROC_glBindBuffersRange)(GLenum target, GLuint first, GLsizei count, const GLuint * buffers, const GLintptr * offsets, const GLsizeiptr * sizes);
	typedef GLvoid (__stdcall * PROC_glBindTextures)(GLuint first, GLsizei count, const GLuint * textures);
	typedef GLvoid (__stdcall * PROC_glBindSamplers)(GLuint first, GLsizei count, const GLuint * samplers);
	typedef GLvoid (__stdcall * PROC_glBindImageTextures)(GLuint first, GLsizei count, const GLuint * textures);
	typedef GLvoid (__stdcall * PROC_glBindVertexBuffers)(GLuint first, GLsizei count, const GLuint * buffers, const GLintptr * offsets, const GLsizei * strides);
	typedef GLvoid (__stdcall * PROC_glClipControl)(GLenum origin, GLenum depth);
	typedef GLvoid (__stdcall * PROC_glCreateTransformFeedbacks)(GLsizei n, GLuint * ids);
	typedef GLvoid (__stdcall * PROC_glTransformFeedbackBufferBase)(GLuint xfb, GLuint index, GLuint buffer);
	typedef GLvoid (__stdcall * PROC_glTransformFeedbackBufferRange)(GLuint xfb, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
	typedef GLvoid (__stdcall * PROC_glGetTransformFeedbackiv)(GLuint xfb, GLenum pname, GLint * param);
	typedef GLvoid (__stdcall * PROC_glGetTransformFeedbacki_v)(GLuint xfb, GLenum pname, GLuint index, GLint * param);
	typedef GLvoid (__stdcall * PROC_glGetTransformFeedbacki64_v)(GLuint xfb, GLenum pname, GLuint index, GLint64 * param);
	typedef GLvoid (__stdcall * PROC_glCreateBuffers)(GLsizei n, GLuint * buffers);
	typedef GLvoid (__stdcall * PROC_glNamedBufferStorage)(GLuint buffer, GLsizeiptr size, const GLvoid * data, GLbitfield flags);
	typedef GLvoid (__stdcall * PROC_glNamedBufferData)(GLuint buffer, GLsizeiptr size, const GLvoid * data, GLenum usage);
	typedef GLvoid (__stdcall * PROC_glNamedBufferSubData)(GLuint buffer, GLintptr offset, GLsizeiptr size, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCopyNamedBufferSubData)(GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
	typedef GLvoid (__stdcall * PROC_glClearNamedBufferData)(GLuint buffer, GLenum internalformat, GLenum format, GLenum type, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glClearNamedBufferSubData)(GLuint buffer, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const GLvoid * data);
	typedef GLvoid * (__stdcall * PROC_glMapNamedBuffer)(GLuint buffer, GLenum access);
	typedef GLvoid * (__stdcall * PROC_glMapNamedBufferRange)(GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access);
	typedef GLboolean (__stdcall * PROC_glUnmapNamedBuffer)(GLuint buffer);
	typedef GLvoid (__stdcall * PROC_glFlushMappedNamedBufferRange)(GLuint buffer, GLintptr offset, GLsizeiptr length);
	typedef GLvoid (__stdcall * PROC_glGetNamedBufferParameteriv)(GLuint buffer, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetNamedBufferParameteri64v)(GLuint buffer, GLenum pname, GLint64 * params);
	typedef GLvoid (__stdcall * PROC_glGetNamedBufferPointerv)(GLuint buffer, GLenum pname, GLvoid ** params);
	typedef GLvoid (__stdcall * PROC_glGetNamedBufferSubData)(GLuint buffer, GLintptr offset, GLsizeiptr size, GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCreateFramebuffers)(GLsizei n, GLuint * framebuffers);
	typedef GLvoid (__stdcall * PROC_glNamedFramebufferRenderbuffer)(GLuint framebuffer, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
	typedef GLvoid (__stdcall * PROC_glNamedFramebufferParameteri)(GLuint framebuffer, GLenum pname, GLint param);
	typedef GLvoid (__stdcall * PROC_glNamedFramebufferTexture)(GLuint framebuffer, GLenum attachment, GLuint texture, GLint level);
	typedef GLvoid (__stdcall * PROC_glNamedFramebufferTextureLayer)(GLuint framebuffer, GLenum attachment, GLuint texture, GLint level, GLint layer);
	typedef GLvoid (__stdcall * PROC_glNamedFramebufferDrawBuffer)(GLuint framebuffer, GLenum buf);
	typedef GLvoid (__stdcall * PROC_glNamedFramebufferDrawBuffers)(GLuint framebuffer, GLsizei n, const GLenum * bufs);
	typedef GLvoid (__stdcall * PROC_glNamedFramebufferReadBuffer)(GLuint framebuffer, GLenum src);
	typedef GLvoid (__stdcall * PROC_glInvalidateNamedFramebufferData)(GLuint framebuffer, GLsizei numAttachments, const GLenum * attachments);
	typedef GLvoid (__stdcall * PROC_glInvalidateNamedFramebufferSubData)(GLuint framebuffer, GLsizei numAttachments, const GLenum * attachments, GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glClearNamedFramebufferiv)(GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLint * value);
	typedef GLvoid (__stdcall * PROC_glClearNamedFramebufferuiv)(GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLuint * value);
	typedef GLvoid (__stdcall * PROC_glClearNamedFramebufferfv)(GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLfloat * value);
	typedef GLvoid (__stdcall * PROC_glClearNamedFramebufferfi)(GLuint framebuffer, GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
	typedef GLvoid (__stdcall * PROC_glBlitNamedFramebuffer)(GLuint readFramebuffer, GLuint drawFramebuffer, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
	typedef GLenum (__stdcall * PROC_glCheckNamedFramebufferStatus)(GLuint framebuffer, GLenum target);
	typedef GLvoid (__stdcall * PROC_glGetNamedFramebufferParameteriv)(GLuint framebuffer, GLenum pname, GLint * param);
	typedef GLvoid (__stdcall * PROC_glGetNamedFramebufferAttachmentParameteriv)(GLuint framebuffer, GLenum attachment, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glCreateRenderbuffers)(GLsizei n, GLuint * renderbuffers);
	typedef GLvoid (__stdcall * PROC_glNamedRenderbufferStorage)(GLuint renderbuffer, GLenum internalformat, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glNamedRenderbufferStorageMultisample)(GLuint renderbuffer, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glGetNamedRenderbufferParameteriv)(GLuint renderbuffer, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glCreateTextures)(GLenum target, GLsizei n, GLuint * textures);
	typedef GLvoid (__stdcall * PROC_glTextureBuffer)(GLuint texture, GLenum internalformat, GLuint buffer);
	typedef GLvoid (__stdcall * PROC_glTextureBufferRange)(GLuint texture, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
	typedef GLvoid (__stdcall * PROC_glTextureStorage1D)(GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width);
	typedef GLvoid (__stdcall * PROC_glTextureStorage2D)(GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glTextureStorage3D)(GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
	typedef GLvoid (__stdcall * PROC_glTextureStorage2DMultisample)(GLuint texture, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
	typedef GLvoid (__stdcall * PROC_glTextureStorage3DMultisample)(GLuint texture, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
	typedef GLvoid (__stdcall * PROC_glTextureSubImage1D)(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glTextureSubImage2D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glTextureSubImage3D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glCompressedTextureSubImage1D)(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCompressedTextureSubImage2D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCompressedTextureSubImage3D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glCopyTextureSubImage1D)(GLuint texture, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
	typedef GLvoid (__stdcall * PROC_glCopyTextureSubImage2D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glCopyTextureSubImage3D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
	typedef GLvoid (__stdcall * PROC_glTextureParameterf)(GLuint texture, GLenum pname, GLfloat param);
	typedef GLvoid (__stdcall * PROC_glTextureParameterfv)(GLuint texture, GLenum pname, const GLfloat * param);
	typedef GLvoid (__stdcall * PROC_glTextureParameteri)(GLuint texture, GLenum pname, GLint param);
	typedef GLvoid (__stdcall * PROC_glTextureParameterIiv)(GLuint texture, GLenum pname, const GLint * params);
	typedef GLvoid (__stdcall * PROC_glTextureParameterIuiv)(GLuint texture, GLenum pname, const GLuint * params);
	typedef GLvoid (__stdcall * PROC_glTextureParameteriv)(GLuint texture, GLenum pname, const GLint * param);
	typedef GLvoid (__stdcall * PROC_glGenerateTextureMipmap)(GLuint texture);
	typedef GLvoid (__stdcall * PROC_glBindTextureUnit)(GLuint unit, GLuint texture);
	typedef GLvoid (__stdcall * PROC_glGetTextureImage)(GLuint texture, GLint level, GLenum format, GLenum type, GLsizei bufSize, GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glGetCompressedTextureImage)(GLuint texture, GLint level, GLsizei bufSize, GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glGetTextureLevelParameterfv)(GLuint texture, GLint level, GLenum pname, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetTextureLevelParameteriv)(GLuint texture, GLint level, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetTextureParameterfv)(GLuint texture, GLenum pname, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetTextureParameterIiv)(GLuint texture, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetTextureParameterIuiv)(GLuint texture, GLenum pname, GLuint * params);
	typedef GLvoid (__stdcall * PROC_glGetTextureParameteriv)(GLuint texture, GLenum pname, GLint * params);
	typedef GLvoid (__stdcall * PROC_glCreateVertexArrays)(GLsizei n, GLuint * arrays);
	typedef GLvoid (__stdcall * PROC_glDisableVertexArrayAttrib)(GLuint vaobj, GLuint index);
	typedef GLvoid (__stdcall * PROC_glEnableVertexArrayAttrib)(GLuint vaobj, GLuint index);
	typedef GLvoid (__stdcall * PROC_glVertexArrayElementBuffer)(GLuint vaobj, GLuint buffer);
	typedef GLvoid (__stdcall * PROC_glVertexArrayVertexBuffer)(GLuint vaobj, GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
	typedef GLvoid (__stdcall * PROC_glVertexArrayVertexBuffers)(GLuint vaobj, GLuint first, GLsizei count, const GLuint * buffers, const GLintptr * offsets, const GLsizei * strides);
	typedef GLvoid (__stdcall * PROC_glVertexArrayAttribBinding)(GLuint vaobj, GLuint attribindex, GLuint bindingindex);
	typedef GLvoid (__stdcall * PROC_glVertexArrayAttribFormat)(GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
	typedef GLvoid (__stdcall * PROC_glVertexArrayAttribIFormat)(GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
	typedef GLvoid (__stdcall * PROC_glVertexArrayAttribLFormat)(GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
	typedef GLvoid (__stdcall * PROC_glVertexArrayBindingDivisor)(GLuint vaobj, GLuint bindingindex, GLuint divisor);
	typedef GLvoid (__stdcall * PROC_glGetVertexArrayiv)(GLuint vaobj, GLenum pname, GLint * param);
	typedef GLvoid (__stdcall * PROC_glGetVertexArrayIndexediv)(GLuint vaobj, GLuint index, GLenum pname, GLint * param);
	typedef GLvoid (__stdcall * PROC_glGetVertexArrayIndexed64iv)(GLuint vaobj, GLuint index, GLenum pname, GLint64 * param);
	typedef GLvoid (__stdcall * PROC_glCreateSamplers)(GLsizei n, GLuint * samplers);
	typedef GLvoid (__stdcall * PROC_glCreateProgramPipelines)(GLsizei n, GLuint * pipelines);
	typedef GLvoid (__stdcall * PROC_glCreateQueries)(GLenum target, GLsizei n, GLuint * ids);
	typedef GLvoid (__stdcall * PROC_glGetQueryBufferObjecti64v)(GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
	typedef GLvoid (__stdcall * PROC_glGetQueryBufferObjectiv)(GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
	typedef GLvoid (__stdcall * PROC_glGetQueryBufferObjectui64v)(GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
	typedef GLvoid (__stdcall * PROC_glGetQueryBufferObjectuiv)(GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
	typedef GLvoid (__stdcall * PROC_glMemoryBarrierByRegion)(GLbitfield barriers);
	typedef GLvoid (__stdcall * PROC_glGetTextureSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, GLsizei bufSize, GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glGetCompressedTextureSubImage)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLsizei bufSize, GLvoid * pixels);
	typedef GLenum (__stdcall * PROC_glGetGraphicsResetStatus)();
	typedef GLvoid (__stdcall * PROC_glGetnCompressedTexImage)(GLenum target, GLint lod, GLsizei bufSize, GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glGetnTexImage)(GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, GLvoid * pixels);
	typedef GLvoid (__stdcall * PROC_glGetnUniformdv)(GLuint program, GLint location, GLsizei bufSize, GLdouble * params);
	typedef GLvoid (__stdcall * PROC_glGetnUniformfv)(GLuint program, GLint location, GLsizei bufSize, GLfloat * params);
	typedef GLvoid (__stdcall * PROC_glGetnUniformiv)(GLuint program, GLint location, GLsizei bufSize, GLint * params);
	typedef GLvoid (__stdcall * PROC_glGetnUniformuiv)(GLuint program, GLint location, GLsizei bufSize, GLuint * params);
	typedef GLvoid (__stdcall * PROC_glReadnPixels)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLvoid * data);
	typedef GLvoid (__stdcall * PROC_glTextureBarrier)();
	...
	extern bool __stdcall isglCullFace();
	extern bool __stdcall isglFrontFace();
	extern bool __stdcall isglHint();
	extern bool __stdcall isglLineWidth();
	extern bool __stdcall isglPointSize();
	extern bool __stdcall isglPolygonMode();
	extern bool __stdcall isglScissor();
	extern bool __stdcall isglTexParameterf();
	extern bool __stdcall isglTexParameterfv();
	extern bool __stdcall isglTexParameteri();
	extern bool __stdcall isglTexParameteriv();
	extern bool __stdcall isglTexImage1D();
	extern bool __stdcall isglTexImage2D();
	extern bool __stdcall isglDrawBuffer();
	extern bool __stdcall isglClear();
	extern bool __stdcall isglClearColor();
	extern bool __stdcall isglClearStencil();
	extern bool __stdcall isglClearDepth();
	extern bool __stdcall isglStencilMask();
	extern bool __stdcall isglColorMask();
	extern bool __stdcall isglDepthMask();
	extern bool __stdcall isglDisable();
	extern bool __stdcall isglEnable();
	extern bool __stdcall isglFinish();
	extern bool __stdcall isglFlush();
	extern bool __stdcall isglBlendFunc();
	extern bool __stdcall isglLogicOp();
	extern bool __stdcall isglStencilFunc();
	extern bool __stdcall isglStencilOp();
	extern bool __stdcall isglDepthFunc();
	extern bool __stdcall isglPixelStoref();
	extern bool __stdcall isglPixelStorei();
	extern bool __stdcall isglReadBuffer();
	extern bool __stdcall isglReadPixels();
	extern bool __stdcall isglGetBooleanv();
	extern bool __stdcall isglGetDoublev();
	extern bool __stdcall isglGetError();
	extern bool __stdcall isglGetFloatv();
	extern bool __stdcall isglGetIntegerv();
	extern bool __stdcall isglGetString();
	extern bool __stdcall isglGetTexImage();
	extern bool __stdcall isglGetTexParameterfv();
	extern bool __stdcall isglGetTexParameteriv();
	extern bool __stdcall isglGetTexLevelParameterfv();
	extern bool __stdcall isglGetTexLevelParameteriv();
	extern bool __stdcall isglIsEnabled();
	extern bool __stdcall isglDepthRange();
	extern bool __stdcall isglViewport();
	extern bool __stdcall isglDrawArrays();
	extern bool __stdcall isglDrawElements();
	extern bool __stdcall isglGetPointerv();
	extern bool __stdcall isglPolygonOffset();
	extern bool __stdcall isglCopyTexImage1D();
	extern bool __stdcall isglCopyTexImage2D();
	extern bool __stdcall isglCopyTexSubImage1D();
	extern bool __stdcall isglCopyTexSubImage2D();
	extern bool __stdcall isglTexSubImage1D();
	...
	extern bool __stdcall isglIsTexture();
	extern bool __stdcall isglDrawRangeElements();
	extern bool __stdcall isglTexImage3D();
	extern bool __stdcall isglTexSubImage3D();
	extern bool __stdcall isglCopyTexSubImage3D();
	extern bool __stdcall isglActiveTexture();
	extern bool __stdcall isglSampleCoverage();
	extern bool __stdcall isglCompressedTexImage3D();
	extern bool __stdcall isglCompressedTexImage2D();
	extern bool __stdcall isglCompressedTexImage1D();
	extern bool __stdcall isglCompressedTexSubImage3D();
	extern bool __stdcall isglCompressedTexSubImage2D();
	extern bool __stdcall isglCompressedTexSubImage1D();
	extern bool __stdcall isglGetCompressedTexImage();
	extern bool __stdcall isglBlendFuncSeparate();
	extern bool __stdcall isglMultiDrawArrays();
	extern bool __stdcall isglMultiDrawElements();
	extern bool __stdcall isglPointParameterf();
	extern bool __stdcall isglPointParameterfv();
	extern bool __stdcall isglPointParameteri();
	extern bool __stdcall isglPointParameteriv();
	extern bool __stdcall isglBlendColor();
	extern bool __stdcall isglBlendEquation();
	extern bool __stdcall isglGenQueries();
	extern bool __stdcall isglDeleteQueries();
	extern bool __stdcall isglIsQuery();
	extern bool __stdcall isglBeginQuery();
	extern bool __stdcall isglEndQuery();
	extern bool __stdcall isglGetQueryiv();
	extern bool __stdcall isglGetQueryObjectiv();
	extern bool __stdcall isglGetQueryObjectuiv();
	extern bool __stdcall isglBindBuffer();
	extern bool __stdcall isglDeleteBuffers();
	extern bool __stdcall isglGenBuffers();
	extern bool __stdcall isglIsBuffer();
	extern bool __stdcall isglBufferData();
	extern bool __stdcall isglBufferSubData();
	extern bool __stdcall isglGetBufferSubData();
	extern bool __stdcall isglMapBuffer();
	extern bool __stdcall isglUnmapBuffer();
	extern bool __stdcall isglGetBufferParameteriv();
	extern bool __stdcall isglGetBufferPointerv();
	extern bool __stdcall isglBlendEquationSeparate();
	extern bool __stdcall isglDrawBuffers();
	extern bool __stdcall isglStencilOpSeparate();
	extern bool __stdcall isglStencilFuncSeparate();
	extern bool __stdcall isglStencilMaskSeparate();
	extern bool __stdcall isglAttachShader();
	extern bool __stdcall isglBindAttribLocation();
	...
	extern bool __stdcall isglDetachShader();
	extern bool __stdcall isglDisableVertexAttribArray();
	extern bool __stdcall isglEnableVertexAttribArray();
	extern bool __stdcall isglGetActiveAttrib();
	extern bool __stdcall isglGetActiveUniform();
	...
	extern bool __stdcall isglGetShaderSource();
	extern bool __stdcall isglGetUniformLocation();
	extern bool __stdcall isglGetUniformfv();
	extern bool __stdcall isglGetUniformiv();
	extern bool __stdcall isglGetVertexAttribdv();
	extern bool __stdcall isglGetVertexAttribfv();
	extern bool __stdcall isglGetVertexAttribiv();
	extern bool __stdcall isglGetVertexAttribPointerv();
	extern bool __stdcall isglIsProgram();
	extern bool __stdcall isglIsShader();
	...
	extern bool __stdcall isglUniform1fv();
	extern bool __stdcall isglUniform2fv();
	extern bool __stdcall isglUniform3fv();
	extern bool __stdcall isglUniform4fv();
	extern bool __stdcall isglUniform1iv();
	extern bool __stdcall isglUniform2iv();
	extern bool __stdcall isglUniform3iv();
	extern bool __stdcall isglUniform4iv();
	extern bool __stdcall isglUniformMatrix2fv();
	extern bool __stdcall isglUniformMatrix3fv();
	extern bool __stdcall isglUniformMatrix4fv();
	extern bool __stdcall isglValidateProgram();
	extern bool __stdcall isglVertexAttrib1d();
	extern bool __stdcall isglVertexAttrib1dv();
	extern bool __stdcall isglVertexAttrib1f();
	extern bool __stdcall isglVertexAttrib1fv();
	extern bool __stdcall isglVertexAttrib1s();
	extern bool __stdcall isglVertexAttrib1sv();
	extern bool __stdcall isglVertexAttrib2d();
	extern bool __stdcall isglVertexAttrib2dv();
	extern bool __stdcall isglVertexAttrib2f();
	extern bool __stdcall isglVertexAttrib2fv();
	extern bool __stdcall isglVertexAttrib2s();
	extern bool __stdcall isglVertexAttrib2sv();
	extern bool __stdcall isglVertexAttrib3d();
	extern bool __stdcall isglVertexAttrib3dv();
	extern bool __stdcall isglVertexAttrib3f();
	extern bool __stdcall isglVertexAttrib3fv();
	extern bool __stdcall isglVertexAttrib3s();
	extern bool __stdcall isglVertexAttrib3sv();
	extern bool __stdcall isglVertexAttrib4Nbv();
	extern bool __stdcall isglVertexAttrib4Niv();
	extern bool __stdcall isglVertexAttrib4Nsv();
	extern bool __stdcall isglVertexAttrib4Nub();
	extern bool __stdcall isglVertexAttrib4Nubv();
	extern bool __stdcall isglVertexAttrib4Nuiv();
	extern bool __stdcall isglVertexAttrib4Nusv();
	extern bool __stdcall isglVertexAttrib4bv();
	extern bool __stdcall isglVertexAttrib4d();
	extern bool __stdcall isglVertexAttrib4dv();
	extern bool __stdcall isglVertexAttrib4f();
	extern bool __stdcall isglVertexAttrib4fv();
	extern bool __stdcall isglVertexAttrib4iv();
	extern bool __stdcall isglVertexAttrib4s();
	extern bool __stdcall isglVertexAttrib4sv();
	extern bool __stdcall isglVertexAttrib4ubv();
	extern bool __stdcall isglVertexAttrib4uiv();
	extern bool __stdcall isglVertexAttrib4usv();
	extern bool __stdcall isglVertexAttribPointer();
	extern bool __stdcall isglUniformMatrix2x3fv();
	extern bool __stdcall isglUniformMatrix3x2fv();
	extern bool __stdcall isglUniformMatrix2x4fv();
	extern bool __stdcall isglUniformMatrix4x2fv();
	extern bool __stdcall isglUniformMatrix3x4fv();
	extern bool __stdcall isglUniformMatrix4x3fv();
	extern bool __stdcall isglColorMaski();
	extern bool __stdcall isglGetBooleani_v();
	extern bool __stdcall isglGetIntegeri_v();
	extern bool __stdcall isglEnablei();
	extern bool __stdcall isglDisablei();
	extern bool __stdcall isglIsEnabledi();
	extern bool __stdcall isglBeginTransformFeedback();
	extern bool __stdcall isglEndTransformFeedback();
	extern bool __stdcall isglBindBufferRange();
	extern bool __stdcall isglBindBufferBase();
	extern bool __stdcall isglTransformFeedbackVaryings();
	extern bool __stdcall isglGetTransformFeedbackVarying();
	extern bool __stdcall isglClampColor();
	extern bool __stdcall isglBeginConditionalRender();
	extern bool __stdcall isglEndConditionalRender();
	extern bool __stdcall isglVertexAttribIPointer();
	extern bool __stdcall isglGetVertexAttribIiv();
	extern bool __stdcall isglGetVertexAttribIuiv();
	extern bool __stdcall isglVertexAttribI1i();
	extern bool __stdcall isglVertexAttribI2i();
	extern bool __stdcall isglVertexAttribI3i();
	extern bool __stdcall isglVertexAttribI4i();
	extern bool __stdcall isglVertexAttribI1ui();
	extern bool __stdcall isglVertexAttribI2ui();
	extern bool __stdcall isglVertexAttribI3ui();
	extern bool __stdcall isglVertexAttribI4ui();
	extern bool __stdcall isglVertexAttribI1iv();
	extern bool __stdcall isglVertexAttribI2iv();
	extern bool __stdcall isglVertexAttribI3iv();
	extern bool __stdcall isglVertexAttribI4iv();
	extern bool __stdcall isglVertexAttribI1uiv();
	extern bool __stdcall isglVertexAttribI2uiv();
	extern bool __stdcall isglVertexAttribI3uiv();
	extern bool __stdcall isglVertexAttribI4uiv();
	extern bool __stdcall isglVertexAttribI4bv();
	extern bool __stdcall isglVertexAttribI4sv();
	extern bool __stdcall isglVertexAttribI4ubv();
	extern bool __stdcall isglVertexAttribI4usv();
	extern bool __stdcall isglGetUniformuiv();
	extern bool __stdcall isglBindFragDataLocation();
	extern bool __stdcall isglGetFragDataLocation();
	extern bool __stdcall isglUniform1ui();
	extern bool __stdcall isglUniform2ui();
	extern bool __stdcall isglUniform3ui();
	extern bool __stdcall isglUniform4ui();
	extern bool __stdcall isglUniform1uiv();
	extern bool __stdcall isglUniform2uiv();
	extern bool __stdcall isglUniform3uiv();
	extern bool __stdcall isglUniform4uiv();
	extern bool __stdcall isglTexParameterIiv();
	extern bool __stdcall isglTexParameterIuiv();
	extern bool __stdcall isglGetTexParameterIiv();
	extern bool __stdcall isglGetTexParameterIuiv();
	extern bool __stdcall isglClearBufferiv();
	extern bool __stdcall isglClearBufferuiv();
	extern bool __stdcall isglClearBufferfv();
	extern bool __stdcall isglClearBufferfi();
	extern bool __stdcall isglGetStringi();
	extern bool __stdcall isglIsRenderbuffer();
	extern bool __stdcall isglBindRenderbuffer();
	extern bool __stdcall isglDeleteRenderbuffers();
	extern bool __stdcall isglGenRenderbuffers();
	extern bool __stdcall isglRenderbufferStorage();
	extern bool __stdcall isglGetRenderbufferParameteriv();
	extern bool __stdcall isglIsFramebuffer();
	...
	extern bool __stdcall isglCheckFramebufferStatus();
	extern bool __stdcall isglFramebufferTexture1D();
	extern bool __stdcall isglFramebufferTexture2D();
	extern bool __stdcall isglFramebufferTexture3D();
	extern bool __stdcall isglFramebufferRenderbuffer();
	extern bool __stdcall isglGetFramebufferAttachmentParameteriv();
	extern bool __stdcall isglGenerateMipmap();
	extern bool __stdcall isglBlitFramebuffer();
	extern bool __stdcall isglRenderbufferStorageMultisample();
	extern bool __stdcall isglFramebufferTextureLayer();
	extern bool __stdcall isglMapBufferRange();
	extern bool __stdcall isglFlushMappedBufferRange();
	...
	extern bool __stdcall isglIsVertexArray();
	extern bool __stdcall isglDrawArraysInstanced();
	extern bool __stdcall isglDrawElementsInstanced();
	extern bool __stdcall isglTexBuffer();
	extern bool __stdcall isglPrimitiveRestartIndex();
	extern bool __stdcall isglCopyBufferSubData();
	extern bool __stdcall isglGetUniformIndices();
	extern bool __stdcall isglGetActiveUniformsiv();
	extern bool __stdcall isglGetActiveUniformName();
	extern bool __stdcall isglGetUniformBlockIndex();
	extern bool __stdcall isglGetActiveUniformBlockiv();
	extern bool __stdcall isglGetActiveUniformBlockName();
	extern bool __stdcall isglUniformBlockBinding();
	extern bool __stdcall isglDrawElementsBaseVertex();
	extern bool __stdcall isglDrawRangeElementsBaseVertex();
	extern bool __stdcall isglDrawElementsInstancedBaseVertex();
	extern bool __stdcall isglMultiDrawElementsBaseVertex();
	extern bool __stdcall isglProvokingVertex();
	extern bool __stdcall isglFenceSync();
	extern bool __stdcall isglIsSync();
	extern bool __stdcall isglDeleteSync();
	extern bool __stdcall isglClientWaitSync();
	extern bool __stdcall isglWaitSync();
	extern bool __stdcall isglGetInteger64v();
	extern bool __stdcall isglGetSynciv();
	extern bool __stdcall isglGetInteger64i_v();
	extern bool __stdcall isglGetBufferParameteri64v();
	extern bool __stdcall isglFramebufferTexture();
	extern bool __stdcall isglTexImage2DMultisample();
	extern bool __stdcall isglTexImage3DMultisample();
	extern bool __stdcall isglGetMultisamplefv();
	extern bool __stdcall isglSampleMaski();
	extern bool __stdcall isglBindFragDataLocationIndexed();
	extern bool __stdcall isglGetFragDataIndex();
	extern bool __stdcall isglGenSamplers();
	extern bool __stdcall isglDeleteSamplers();
	extern bool __stdcall isglIsSampler();
	extern bool __stdcall isglBindSampler();
	extern bool __stdcall isglSamplerParameteri();
	extern bool __stdcall isglSamplerParameteriv();
	extern bool __stdcall isglSamplerParameterf();
	extern bool __stdcall isglSamplerParameterfv();
	extern bool __stdcall isglSamplerParameterIiv();
	extern bool __stdcall isglSamplerParameterIuiv();
	extern bool __stdcall isglGetSamplerParameteriv();
	extern bool __stdcall isglGetSamplerParameterIiv();
	extern bool __stdcall isglGetSamplerParameterfv();
	extern bool __stdcall isglGetSamplerParameterIuiv();
	extern bool __stdcall isglQueryCounter();
	extern bool __stdcall isglGetQueryObjecti64v();
	extern bool __stdcall isglGetQueryObjectui64v();
	extern bool __stdcall isglVertexAttribDivisor();
	extern bool __stdcall isglVertexAttribP1ui();
	extern bool __stdcall isglVertexAttribP1uiv();
	extern bool __stdcall isglVertexAttribP2ui();
	extern bool __stdcall isglVertexAttribP2uiv();
	extern bool __stdcall isglVertexAttribP3ui();
	extern bool __stdcall isglVertexAttribP3uiv();
	extern bool __stdcall isglVertexAttribP4ui();
	extern bool __stdcall isglVertexAttribP4uiv();
	extern bool __stdcall isglMinSampleShading();
	extern bool __stdcall isglBlendEquationi();
	extern bool __stdcall isglBlendEquationSeparatei();
	extern bool __stdcall isglBlendFunci();
	extern bool __stdcall isglBlendFuncSeparatei();
	extern bool __stdcall isglDrawArraysIndirect();
	extern bool __stdcall isglDrawElementsIndirect();
	extern bool __stdcall isglUniform1d();
	extern bool __stdcall isglUniform2d();
	extern bool __stdcall isglUniform3d();
	extern bool __stdcall isglUniform4d();
	extern bool __stdcall isglUniform1dv();
	extern bool __stdcall isglUniform2dv();
	extern bool __stdcall isglUniform3dv();
	extern bool __stdcall isglUniform4dv();
	extern bool __stdcall isglUniformMatrix2dv();
	extern bool __stdcall isglUniformMatrix3dv();
	extern bool __stdcall isglUniformMatrix4dv();
	extern bool __stdcall isglUniformMatrix2x3dv();
	extern bool __stdcall isglUniformMatrix2x4dv();
	extern bool __stdcall isglUniformMatrix3x2dv();
	extern bool __stdcall isglUniformMatrix3x4dv();
	extern bool __stdcall isglUniformMatrix4x2dv();
	extern bool __stdcall isglUniformMatrix4x3dv();
	extern bool __stdcall isglGetUniformdv();
	extern bool __stdcall isglGetSubroutineUniformLocation();
	extern bool __stdcall isglGetSubroutineIndex();
	extern bool __stdcall isglGetActiveSubroutineUniformiv();
	extern bool __stdcall isglGetActiveSubroutineUniformName();
	extern bool __stdcall isglGetActiveSubroutineName();
	extern bool __stdcall isglUniformSubroutinesuiv();
	extern bool __stdcall isglGetUniformSubroutineuiv();
	extern bool __stdcall isglGetProgramStageiv();
	extern bool __stdcall isglPatchParameteri();
	extern bool __stdcall isglPatchParameterfv();
	extern bool __stdcall isglBindTransformFeedback();
	extern bool __stdcall isglDeleteTransformFeedbacks();
	extern bool __stdcall isglGenTransformFeedbacks();
	extern bool __stdcall isglIsTransformFeedback();
	extern bool __stdcall isglPauseTransformFeedback();
	extern bool __stdcall isglResumeTransformFeedback();
	extern bool __stdcall isglDrawTransformFeedback();
	extern bool __stdcall isglDrawTransformFeedbackStream();
	extern bool __stdcall isglBeginQueryIndexed();
	extern bool __stdcall isglEndQueryIndexed();
	extern bool __stdcall isglGetQueryIndexediv();
	extern bool __stdcall isglReleaseShaderCompiler();
	extern bool __stdcall isglShaderBinary();
	extern bool __stdcall isglGetShaderPrecisionFormat();
	extern bool __stdcall isglDepthRangef();
	extern bool __stdcall isglClearDepthf();
	extern bool __stdcall isglGetProgramBinary();
	extern bool __stdcall isglProgramBinary();
	extern bool __stdcall isglProgramParameteri();
	extern bool __stdcall isglUseProgramStages();
	extern bool __stdcall isglActiveShaderProgram();
	extern bool __stdcall isglCreateShaderProgramv();
	extern bool __stdcall isglBindProgramPipeline();
	extern bool __stdcall isglDeleteProgramPipelines();
	extern bool __stdcall isglGenProgramPipelines();
	extern bool __stdcall isglIsProgramPipeline();
	extern bool __stdcall isglGetProgramPipelineiv();
	extern bool __stdcall isglProgramUniform1i();
	extern bool __stdcall isglProgramUniform1iv();
	extern bool __stdcall isglProgramUniform1f();
	extern bool __stdcall isglProgramUniform1fv();
	extern bool __stdcall isglProgramUniform1d();
	extern bool __stdcall isglProgramUniform1dv();
	extern bool __stdcall isglProgramUniform1ui();
	extern bool __stdcall isglProgramUniform1uiv();
	extern bool __stdcall isglProgramUniform2i();
	extern bool __stdcall isglProgramUniform2iv();
	extern bool __stdcall isglProgramUniform2f();
	extern bool __stdcall isglProgramUniform2fv();
	extern bool __stdcall isglProgramUniform2d();
	extern bool __stdcall isglProgramUniform2dv();
	extern bool __stdcall isglProgramUniform2ui();
	extern bool __stdcall isglProgramUniform2uiv();
	extern bool __stdcall isglProgramUniform3i();
	extern bool __stdcall isglProgramUniform3iv();
	extern bool __stdcall isglProgramUniform3f();
	extern bool __stdcall isglProgramUniform3fv();
	extern bool __stdcall isglProgramUniform3d();
	extern bool __stdcall isglProgramUniform3dv();
	extern bool __stdcall isglProgramUniform3ui();
	extern bool __stdcall isglProgramUniform3uiv();
	extern bool __stdcall isglProgramUniform4i();
	extern bool __stdcall isglProgramUniform4iv();
	extern bool __stdcall isglProgramUniform4f();
	extern bool __stdcall isglProgramUniform4fv();
	extern bool __stdcall isglProgramUniform4d();
	extern bool __stdcall isglProgramUniform4dv();
	extern bool __stdcall isglProgramUniform4ui();
	extern bool __stdcall isglProgramUniform4uiv();
	extern bool __stdcall isglProgramUniformMatrix2fv();
	extern bool __stdcall isglProgramUniformMatrix3fv();
	extern bool __stdcall isglProgramUniformMatrix4fv();
	extern bool __stdcall isglProgramUniformMatrix2dv();
	extern bool __stdcall isglProgramUniformMatrix3dv();
	extern bool __stdcall isglProgramUniformMatrix4dv();
	extern bool __stdcall isglProgramUniformMatrix2x3fv();
	extern bool __stdcall isglProgramUniformMatrix3x2fv();
	extern bool __stdcall isglProgramUniformMatrix2x4fv();
	extern bool __stdcall isglProgramUniformMatrix4x2fv();
	extern bool __stdcall isglProgramUniformMatrix3x4fv();
	extern bool __stdcall isglProgramUniformMatrix4x3fv();
	extern bool __stdcall isglProgramUniformMatrix2x3dv();
	extern bool __stdcall isglProgramUniformMatrix3x2dv();
	extern bool __stdcall isglProgramUniformMatrix2x4dv();
	extern bool __stdcall isglProgramUniformMatrix4x2dv();
	extern bool __stdcall isglProgramUniformMatrix3x4dv();
	extern bool __stdcall isglProgramUniformMatrix4x3dv();
	extern bool __stdcall isglValidateProgramPipeline();
	extern bool __stdcall isglGetProgramPipelineInfoLog();
	extern bool __stdcall isglVertexAttribL1d();
	extern bool __stdcall isglVertexAttribL2d();
	extern bool __stdcall isglVertexAttribL3d();
	extern bool __stdcall isglVertexAttribL4d();
	extern bool __stdcall isglVertexAttribL1dv();
	extern bool __stdcall isglVertexAttribL2dv();
	extern bool __stdcall isglVertexAttribL3dv();
	extern bool __stdcall isglVertexAttribL4dv();
	extern bool __stdcall isglVertexAttribLPointer();
	extern bool __stdcall isglGetVertexAttribLdv();
	extern bool __stdcall isglViewportArrayv();
	extern bool __stdcall isglViewportIndexedf();
	extern bool __stdcall isglViewportIndexedfv();
	extern bool __stdcall isglScissorArrayv();
	extern bool __stdcall isglScissorIndexed();
	extern bool __stdcall isglScissorIndexedv();
	extern bool __stdcall isglDepthRangeArrayv();
	extern bool __stdcall isglDepthRangeIndexed();
	extern bool __stdcall isglGetFloati_v();
	extern bool __stdcall isglGetDoublei_v();
	extern bool __stdcall isglDrawArraysInstancedBaseInstance();
	extern bool __stdcall isglDrawElementsInstancedBaseInstance();
	extern bool __stdcall isglDrawElementsInstancedBaseVertexBaseInstance();
	extern bool __stdcall isglGetInternalformativ();
	extern bool __stdcall isglGetActiveAtomicCounterBufferiv();
	extern bool __stdcall isglBindImageTexture();
	extern bool __stdcall isglMemoryBarrier();
	extern bool __stdcall isglTexStorage1D();
	extern bool __stdcall isglTexStorage2D();
	extern bool __stdcall isglTexStorage3D();
	extern bool __stdcall isglDrawTransformFeedbackInstanced();
	extern bool __stdcall isglDrawTransformFeedbackStreamInstanced();
	extern bool __stdcall isglClearBufferData();
	extern bool __stdcall isglClearBufferSubData();
	extern bool __stdcall isglDispatchCompute();
	extern bool __stdcall isglDispatchComputeIndirect();
	extern bool __stdcall isglCopyImageSubData();
	extern bool __stdcall isglFramebufferParameteri();
	extern bool __stdcall isglGetFramebufferParameteriv();
	extern bool __stdcall isglGetInternalformati64v();
	extern bool __stdcall isglInvalidateTexSubImage();
	extern bool __stdcall isglInvalidateTexImage();
	extern bool __stdcall isglInvalidateBufferSubData();
	extern bool __stdcall isglInvalidateBufferData();
	extern bool __stdcall isglInvalidateFramebuffer();
	extern bool __stdcall isglInvalidateSubFramebuffer();
	extern bool __stdcall isglMultiDrawArraysIndirect();
	extern bool __stdcall isglMultiDrawElementsIndirect();
	extern bool __stdcall isglGetProgramInterfaceiv();
	extern bool __stdcall isglGetProgramResourceIndex();
	extern bool __stdcall isglGetProgramResourceName();
	extern bool __stdcall isglGetProgramResourceiv();
	extern bool __stdcall isglGetProgramResourceLocation();
	extern bool __stdcall isglGetProgramResourceLocationIndex();
	extern bool __stdcall isglShaderStorageBlockBinding();
	extern bool __stdcall isglTexBufferRange();
	extern bool __stdcall isglTexStorage2DMultisample();
	extern bool __stdcall isglTexStorage3DMultisample();
	extern bool __stdcall isglTextureView();
	extern bool __stdcall isglBindVertexBuffer();
	extern bool __stdcall isglVertexAttribFormat();
	extern bool __stdcall isglVertexAttribIFormat();
	extern bool __stdcall isglVertexAttribLFormat();
	extern bool __stdcall isglVertexAttribBinding();
	extern bool __stdcall isglVertexBindingDivisor();
	extern bool __stdcall isglDebugMessageControl();
	extern bool __stdcall isglDebugMessageInsert();
	extern bool __stdcall isglDebugMessageCallback();
	extern bool __stdcall isglGetDebugMessageLog();
	extern bool __stdcall isglPushDebugGroup();
	extern bool __stdcall isglPopDebugGroup();
	extern bool __stdcall isglObjectLabel();
	extern bool __stdcall isglGetObjectLabel();
	extern bool __stdcall isglObjectPtrLabel();
	extern bool __stdcall isglGetObjectPtrLabel();
	extern bool __stdcall isglBufferStorage();
	extern bool __stdcall isglClearTexImage();
	extern bool __stdcall isglClearTexSubImage();
	extern bool __stdcall isglBindBuffersBase();
	extern bool __stdcall isglBindBuffersRange();
	extern bool __stdcall isglBindTextures();
	extern bool __stdcall isglBindSamplers();
	extern bool __stdcall isglBindImageTextures();
	extern bool __stdcall isglBindVertexBuffers();
	extern bool __stdcall isglClipControl();
	extern bool __stdcall isglCreateTransformFeedbacks();
	extern bool __stdcall isglTransformFeedbackBufferBase();
	extern bool __stdcall isglTransformFeedbackBufferRange();
	extern bool __stdcall isglGetTransformFeedbackiv();
	extern bool __stdcall isglGetTransformFeedbacki_v();
	extern bool __stdcall isglGetTransformFeedbacki64_v();
	extern bool __stdcall isglCreateBuffers();
	extern bool __stdcall isglNamedBufferStorage();
	extern bool __stdcall isglNamedBufferData();
	extern bool __stdcall isglNamedBufferSubData();
	extern bool __stdcall isglCopyNamedBufferSubData();
	extern bool __stdcall isglClearNamedBufferData();
	extern bool __stdcall isglClearNamedBufferSubData();
	extern bool __stdcall isglMapNamedBuffer();
	extern bool __stdcall isglMapNamedBufferRange();
	extern bool __stdcall isglUnmapNamedBuffer();
	extern bool __stdcall isglFlushMappedNamedBufferRange();
	extern bool __stdcall isglGetNamedBufferParameteriv();
	extern bool __stdcall isglGetNamedBufferParameteri64v();
	extern bool __stdcall isglGetNamedBufferPointerv();
	extern bool __stdcall isglGetNamedBufferSubData();
	extern bool __stdcall isglCreateFramebuffers();
	extern bool __stdcall isglNamedFramebufferRenderbuffer();
	extern bool __stdcall isglNamedFramebufferParameteri();
	extern bool __stdcall isglNamedFramebufferTexture();
	extern bool __stdcall isglNamedFramebufferTextureLayer();
	extern bool __stdcall isglNamedFramebufferDrawBuffer();
	extern bool __stdcall isglNamedFramebufferDrawBuffers();
	extern bool __stdcall isglNamedFramebufferReadBuffer();
	extern bool __stdcall isglInvalidateNamedFramebufferData();
	extern bool __stdcall isglInvalidateNamedFramebufferSubData();
	extern bool __stdcall isglClearNamedFramebufferiv();
	extern bool __stdcall isglClearNamedFramebufferuiv();
	extern bool __stdcall isglClearNamedFramebufferfv();
	extern bool __stdcall isglClearNamedFramebufferfi();
	extern bool __stdcall isglBlitNamedFramebuffer();
	extern bool __stdcall isglCheckNamedFramebufferStatus();
	extern bool __stdcall isglGetNamedFramebufferParameteriv();
	extern bool __stdcall isglGetNamedFramebufferAttachmentParameteriv();
	extern bool __stdcall isglCreateRenderbuffers();
	extern bool __stdcall isglNamedRenderbufferStorage();
	extern bool __stdcall isglNamedRenderbufferStorageMultisample();
	extern bool __stdcall isglGetNamedRenderbufferParameteriv();
	extern bool __stdcall isglCreateTextures();
	extern bool __stdcall isglTextureBuffer();
	extern bool __stdcall isglTextureBufferRange();
	extern bool __stdcall isglTextureStorage1D();
	extern bool __stdcall isglTextureStorage2D();
	extern bool __stdcall isglTextureStorage3D();
	extern bool __stdcall isglTextureStorage2DMultisample();
	extern bool __stdcall isglTextureStorage3DMultisample();
	extern bool __stdcall isglTextureSubImage1D();
	extern bool __stdcall isglTextureSubImage2D();
	extern bool __stdcall isglTextureSubImage3D();
	extern bool __stdcall isglCompressedTextureSubImage1D();
	extern bool __stdcall isglCompressedTextureSubImage2D();
	extern bool __stdcall isglCompressedTextureSubImage3D();
	extern bool __stdcall isglCopyTextureSubImage1D();
	extern bool __stdcall isglCopyTextureSubImage2D();
	extern bool __stdcall isglCopyTextureSubImage3D();
	extern bool __stdcall isglTextureParameterf();
	extern bool __stdcall isglTextureParameterfv();
	extern bool __stdcall isglTextureParameteri();
	extern bool __stdcall isglTextureParameterIiv();
	extern bool __stdcall isglTextureParameterIuiv();
	extern bool __stdcall isglTextureParameteriv();
	extern bool __stdcall isglGenerateTextureMipmap();
	extern bool __stdcall isglBindTextureUnit();
	extern bool __stdcall isglGetTextureImage();
	extern bool __stdcall isglGetCompressedTextureImage();
	extern bool __stdcall isglGetTextureLevelParameterfv();
	extern bool __stdcall isglGetTextureLevelParameteriv();
	extern bool __stdcall isglGetTextureParameterfv();
	extern bool __stdcall isglGetTextureParameterIiv();
	extern bool __stdcall isglGetTextureParameterIuiv();
	extern bool __stdcall isglGetTextureParameteriv();
	extern bool __stdcall isglCreateVertexArrays();
	extern bool __stdcall isglDisableVertexArrayAttrib();
	extern bool __stdcall isglEnableVertexArrayAttrib();
	extern bool __stdcall isglVertexArrayElementBuffer();
	extern bool __stdcall isglVertexArrayVertexBuffer();
	extern bool __stdcall isglVertexArrayVertexBuffers();
	extern bool __stdcall isglVertexArrayAttribBinding();
	extern bool __stdcall isglVertexArrayAttribFormat();
	extern bool __stdcall isglVertexArrayAttribIFormat();
	extern bool __stdcall isglVertexArrayAttribLFormat();
	extern bool __stdcall isglVertexArrayBindingDivisor();
	extern bool __stdcall isglGetVertexArrayiv();
	extern bool __stdcall isglGetVertexArrayIndexediv();
	extern bool __stdcall isglGetVertexArrayIndexed64iv();
	extern bool __stdcall isglCreateSamplers();
	extern bool __stdcall isglCreateProgramPipelines();
	extern bool __stdcall isglCreateQueries();
	extern bool __stdcall isglGetQueryBufferObjecti64v();
	extern bool __stdcall isglGetQueryBufferObjectiv();
	extern bool __stdcall isglGetQueryBufferObjectui64v();
	extern bool __stdcall isglGetQueryBufferObjectuiv();
	extern bool __stdcall isglMemoryBarrierByRegion();
	extern bool __stdcall isglGetTextureSubImage();
	extern bool __stdcall isglGetCompressedTextureSubImage();
	extern bool __stdcall isglGetGraphicsResetStatus();
	extern bool __stdcall isglGetnCompressedTexImage();
	extern bool __stdcall isglGetnTexImage();
	extern bool __stdcall isglGetnUniformdv();
	extern bool __stdcall isglGetnUniformfv();
	extern bool __stdcall isglGetnUniformiv();
	extern bool __stdcall isglGetnUniformuiv();
	extern bool __stdcall isglReadnPixels();
	extern bool __stdcall isglTextureBarrier();
