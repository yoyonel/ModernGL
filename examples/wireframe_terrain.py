    ...
    def __init__(self, **kwargs):
        ...
        self.prog = self.ctx.program(
            vertex_shader='''
                ...
                void main() {
                    v_color = in_color;
                    //float height = texture(Heightmap, vec3(in_vert.xy, time)).r * 0.5;
                    float height = texture(Heightmap, vec3(in_vert.xy, 0.0)).r * 0.5;
                    //float height = 0.0;
            ...
            fragment_shader='''
                ...
                void main() {
                    ...
                    f_color = texture(Texture, v_text) * 10;
                }
            ''',
        )
