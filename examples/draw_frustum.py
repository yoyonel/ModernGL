...
class SystemCameraQuaternion(CameraQuaternion):
    ...
    def __init__(self, fov=60, aspect=1.0, near=1, far=100):
        ...
        self.mv = creative_modelview_from_position_orientation(self.position, self.orientation)
...
class DrawFrustumExample(Example):
    ...
    def render(self):
        ...
        self.sys_camera.set_position(*pos_frustum)
        mvp_frustum = self.sys_camera.projection.matrix * self.sys_camera.view_matrix
