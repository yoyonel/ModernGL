...
PyObject * MGLUniform_bool_value_getter(MGLUniform * self) {
	int value = 0;
	((gl_uniform_reader_proc /*glGetUniformiv*/)self->gl_value_reader_proc)(self->program->obj, self->location, &value);
	return PyBool_FromLong(value);
}

PyObject * MGLUniform_bvec2_value_getter(MGLUniform * self) {
	int values[2] = {};
	((gl_uniform_reader_proc /*glGetUniformiv*/)self->gl_value_reader_proc)(self->program->obj, self->location, values);
	return PyTuple_Pack(
		2,
...
PyObject * MGLUniform_uint_value_getter(MGLUniform * self) {
	unsigned value = 0;
	((gl_uniform_reader_proc /*glGetUniformuiv*/)self->gl_value_reader_proc)(self->program->obj, self->location, &value);
	return PyLong_FromUnsignedLong(value);
}

PyObject * MGLUniform_uvec2_value_getter(MGLUniform * self) {
	unsigned values[2] = {};
	((gl_uniform_reader_proc /*glGetUniformuiv*/)self->gl_value_reader_proc)(self->program->obj, self->location, values);
	return PyTuple_Pack(
		2,
...
PyObject * MGLUniform_float_value_getter(MGLUniform * self) {
	float value = 0;
	((gl_uniform_reader_proc /*glGetUniformfv*/)self->gl_value_reader_proc)(self->program->obj, self->location, &value);
	return PyFloat_FromDouble(value);
}

PyObject * MGLUniform_vec2_value_getter(MGLUniform * self) {
	float values[2] = {};
	((gl_uniform_reader_proc /*glGetUniformfv*/)self->gl_value_reader_proc)(self->program->obj, self->location, values);
	return PyTuple_Pack(
		2,
...
PyObject * MGLUniform_double_value_getter(MGLUniform * self) {
	double value = 0;
	((gl_uniform_reader_proc /*glGetUniformdv*/)self->gl_value_reader_proc)(self->program->obj, self->location, &value);
	return PyFloat_FromDouble(value);
}

PyObject * MGLUniform_dvec2_value_getter(MGLUniform * self) {
	double values[2] = {};
	((gl_uniform_reader_proc /*glGetUniformdv*/)self->gl_value_reader_proc)(self->program->obj, self->location, values);
	return PyTuple_Pack(
		2,
		PyFloat_FromDouble(values[0]),
		PyFloat_FromDouble(values[1])
...
PyObject * MGLUniform_bool_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		int value = 0;
		((gl_uniform_reader_proc /*glGetUniformiv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, &value);
...
PyObject * MGLUniform_bvec2_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		int values[2] = {};
		((gl_uniform_reader_proc /*glGetUniformiv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, values);
...
PyObject * MGLUniform_uint_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		unsigned value = 0;
		((gl_uniform_reader_proc /*glGetUniformuiv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, &value);
...
PyObject * MGLUniform_uvec2_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		...
		unsigned values[2] = {};
		((gl_uniform_reader_proc /*glGetUniformuiv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, values);
		PyObject * tuple = PyTuple_Pack(
			2,
			PyLong_FromUnsignedLong(values[0]),
			PyLong_FromUnsignedLong(values[1])
...
PyObject * MGLUniform_float_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		float value = 0;
		((gl_uniform_reader_proc /*glGetUniformfv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, &value);
...
PyObject * MGLUniform_vec2_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		...
		float values[2] = {};
		((gl_uniform_reader_proc /*glGetUniformfv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, values);
		PyObject * tuple = PyTuple_Pack(
			2,
			PyFloat_FromDouble(values[0]),
			PyFloat_FromDouble(values[1])
...
PyObject * MGLUniform_double_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		double value = 0;
		((gl_uniform_reader_proc /*glGetUniformdv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, &value);
		PyList_SET_ITEM(lst, i, PyFloat_FromDouble(value));
	}
...
PyObject * MGLUniform_dvec2_array_value_getter(MGLUniform * self) {
	...
	for (int i = 0; i < size; ++i) {
		...
		double values[2] = {};
		((gl_uniform_reader_proc /*glGetUniformdv*/)self->gl_value_reader_proc)(self->program->obj, self->location + i, values);
		PyObject * tuple = PyTuple_Pack(
			2,
			PyFloat_FromDouble(values[0]),
			PyFloat_FromDouble(values[1])
