...
int MGLUniform_bool_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (value == Py_True) {
		...
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a bool not %s", Py_TYPE(value)->tp_name);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_bvec2_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (Py_TYPE(value) != &PyTuple_Type) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple not %s", Py_TYPE(value));
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
	...
	if (size != 2) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 2 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_bvec3_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (size != 3) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 3 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_bvec4_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (size != 4) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 4 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_uint_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (PyErr_Occurred()) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be an unsigned int not %s", Py_TYPE(value));
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_float_matrix_2x3_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (size != 6) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 6 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_float_matrix_2x4_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (size != 8) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 8 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_float_matrix_3x3_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (size != 9) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 9 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_float_matrix_3x4_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (size != 12) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 12 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_float_matrix_4x4_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (size != 16) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a tuple of size 16 not %d", size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
...
int MGLUniform_bool_array_value_setter(MGLUniform * self, PyObject * value) {
	...
	if (Py_TYPE(value) != &PyList_Type) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a list not %s", Py_TYPE(value));
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
	...
	if (size != self->array_length) {
		MGLError * error = MGLError_FromFormat(TRACE, "the value must be a list of size %d not %d", self->array_length, size);
		PyErr_SetObject((PyObject *)&MGLError_Type, (PyObject *)error);
		return -1;
	}
