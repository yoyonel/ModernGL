...
int MGLUniform_bool_value_setter(MGLUniform * self, PyObject * value) {
	...
	MGL_GLMETHOD_DBG_UNIFORM_WRITER(self->gl_value_writer_proc, self->program_obj, self->location, 1, &c_value);
...
int MGLUniform_bool_array_value_setter(MGLUniform * self, PyObject * value) {
	...
	MGL_GLMETHOD_DBG_UNIFORM_WRITER(self->gl_value_writer_proc, self->program_obj, self->location, size, c_values);
...
int MGLUniform_bvec_value_setter(MGLUniform * self, PyObject * value) {
	...
	MGL_GLMETHOD_DBG_UNIFORM_WRITER(self->gl_value_writer_proc, self->program_obj, self->location, 1, c_values);
...
int MGLUniform_bvec_array_value_setter(MGLUniform * self, PyObject * value) {
	...
	MGL_GLMETHOD_DBG_UNIFORM_WRITER(self->gl_value_writer_proc, self->program_obj, self->location, size * N, c_values);
...
int MGLUniform_matrix_value_setter(MGLUniform * self, PyObject * value) {
	...
	MGL_GLMETHOD_DBG_UNIFORM_WRITER(self->gl_value_writer_proc, self->program_obj, self->location, 1, false, c_values);
...
int MGLUniform_matrix_array_value_setter(MGLUniform * self, PyObject * value) {
	...
	MGL_GLMETHOD_DBG_UNIFORM_WRITER(self->gl_value_writer_proc, self->program_obj, self->location, size, false, c_values);
